...
PAGE 1 :
   ...
   //ZONE7B     : origin = 0x20FC00, length = 0x000400     /* XINTF zone 7 - data space */ /* disabled redefined below */
   ZONE7C	  : origin = 0x200000, length = 0x01FFFF	/* Ext. RAM of 128kx16b */
   // ZONE 7D is available on eZdsp replcement by T.Kosan !!! Otherwise this region
   // is mirrored to ZONE 7C
   ZONE7D	  : origin = 0x220000, length = 0x01FFFF	/* Ext RAM of 128kx16b */
}
...
SECTIONS
{
   ...
   .text            : >> RAML1 | RAML2 | RAML3 | RAML4 | RAML5,     PAGE = 0
   .cinit           : > RAML0,     PAGE = 0
   .pinit           : > RAML0,     PAGE = 0
   .switch          : > RAML0,     PAGE = 0
   ...
   */
   ...
   ZONE7DATA		: > ZONE7C,	   PAGE = 1
   ZONE7DATA2		: > ZONE7D,	   PAGE = 1
